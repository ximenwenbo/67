<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"F:\www\php68\public/../application/admin\view\goods\tianjia.html";i:1540732277;s:49:"F:\www\php68\application\admin\view\pub\head.html";i:1532091344;s:57:"F:\www\php68\application\admin\view\goods\js_tianjia.html";i:1536982651;s:49:"F:\www\php68\application\admin\view\pub\foot.html";i:1532090900;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div id="tab-category" class="HuiTab">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value=""  id="goods_name" name="goods_name">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value=""  id="goods_price" name="goods_price">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>数量：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value=""  id="goods_number" name="goods_number">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>重量：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value=""  id="goods_weight" name="goods_weight">
					</div>
				</div>
			...
			<div class="tabCon">
				...
				<textarea id="goods_introduce" name="goods_introduce"
						  style="width:540px;height:180px;"></textarea>
					</div>
				</div>
			...
			<div class="tabCon">
				<div class="row cl" id="goods_type_attr">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<select name="type_id" onchange="show_attribute2()">
			...
			<div class="tabCon">
				<link type="text/css" rel="stylesheet"
					  href="<?php echo config('plugin'); ?>/jedate/skin/jedate.css" />
				<script type="text/javascript"
						src="<?php echo config('plugin'); ?>/jedate/src/jedate.js"></script>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">开始时间：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"
							   name="start_time" id="start_time" /></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">结束时间：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"
							   name="end_time" id="end_time" /></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">秒杀价格：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" name="goods_price_seckill" /></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">秒杀数量：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="number" class="input-text" name="goods_number_seckill" /></div>
				</div>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success:function(msg){
                $.fn.zTree.init($("#mytree2"), setting, msg);
            }
        });
    });
    ...
    /**
     * 根据选中的 类型 获得对应 的属性表单域
     */
    function show_attribute2(){
        //获得选中类型的type_id信息
        ...
        $.ajax({
            url:'<?php echo url("attribute/showattribute2"); ?>',
    ...
    $(function(){
        $('#form-member-add').submit(function(evt){
            ...
            $.ajax({
                ...
                //url:'<?php echo url("admin/goods/tianjia"); ?>',    // /admin/goods/tianjia.html
                url:'<?php echo url("tianjia","",false); ?>',    // /admin/goods/tianjia
                data:shuju,
                dataType:'json',
                type:'post',
                success:function(msg){
                    if(msg.status=='success'){
                        layer.alert('添加商品成功',{icon:6},function(){
                            //下述① 和 ②执行执行顺序要求
                            //① 在"父级"页面把新添加商品刷新出来
