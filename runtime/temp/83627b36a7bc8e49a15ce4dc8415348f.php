<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\www\php68\public/../application/home\view\goods\index.html";i:1534929226;s:48:"F:\www\php68\application\home\view\pub\head.html";i:1535290836;s:48:"F:\www\php68\application\home\view\pub\foot.html";i:1533952410;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="py-container">
			...
			<div class="details">
				...
				<div class="goods-list">
					<ul class="yui3-g">
						<?php if(!(empty($goodsinfos) || (($goodsinfos instanceof \think\Collection || $goodsinfos instanceof \think\Paginator ) && $goodsinfos->isEmpty()))): if(is_array($goodsinfos) || $goodsinfos instanceof \think\Collection || $goodsinfos instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsinfos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
							<li class="yui3-u-1-5">
								<div class="list-wrap">
									<div class="p-img">
										<a href="<?php echo url('detail',['goods_id'=>$v['goods_id']]); ?>" target="_blank">
											<img src="<?php echo substr($v['goods_logo'],1); ?>"
												 style="width:215px;height:254px;" alt=""/></a>
									</div>
									<div class="price">
										<strong><em>¥</em><i>&nbsp;<?php echo $v['goods_price']; ?></i></strong>
									</div>
							...
							<li style="width:100px;font-size:15px;">没有任何记录！</li>
						<?php endif; ?>
					</ul>
				</div>
				<div class="fr page">
