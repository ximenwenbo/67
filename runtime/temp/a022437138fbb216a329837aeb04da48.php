<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"F:\www\php68\public/../application/admin\view\role\index.html";i:1532328911;s:49:"F:\www\php68\application\admin\view\pub\head.html";i:1532091344;s:54:"F:\www\php68\application\admin\view\role\js_index.html";i:1532785596;s:49:"F:\www\php68\application\admin\view\pub\foot.html";i:1532090900;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		...
		<a href="javascript:;" onclick="member_add('添加角色','<?php echo url('tianjia'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo $v['role_ps_ids']; ?></td>
				<td><?php echo $v['role_ps_ca']; ?></td>
				<td><?php echo $v['create_time']; ?></td>
				<td class="td-manage">
					<a title="编辑" href="javascript:;"
					   onclick="member_edit('编辑','<?php echo url('xiugai',['role_id'=>$v['role_id']]); ?>','4','','510')"
					   class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>


					<a title="删除" href="javascript:;" onclick="member_del(this,<?php echo $v['role_id']; ?>)"
