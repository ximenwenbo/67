<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\www\php68\public/../application/admin\view\manager\login.html";i:1540910691;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div id="loginform" class="loginBox">
    ...
    <form class="form form-horizontal" action="<?php echo \think\Request::instance()->url(); ?>" method="post">
      ...
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input name="mg_pwd" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
