<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"F:\www\php68\public/../application/admin\view\role\tianjia.html";i:1532764141;s:49:"F:\www\php68\application\admin\view\pub\head.html";i:1532091344;s:56:"F:\www\php68\application\admin\view\role\js_tianjia.html";i:1532651607;s:49:"F:\www\php68\application\admin\view\pub\foot.html";i:1532090900;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<dl class="permission-list">
					<dt><label>
						<input type="checkbox"  value="<?php echo $v['ps_id']; ?>" name="role_ps_ids[]"
							   id="user-Character-0"
					...
					<dd>
						...
						<dl class="cl permission-list2">
							<dt><label class="">
								<input type="checkbox" value="<?php echo $vv['ps_id']; ?>" name="role_ps_ids[]"
							...
							<dd>
								...
								<label class="">
									<input type="checkbox"  name="role_ps_ids[]"
										   value="<?php echo $vvv['ps_id']; ?>" id="user-Character-0-0-0"
...
<script type="text/javascript">
    ...
    $(function(){
        $('#form-member-add').submit(function(evt){
            ...
            //ajax传递数据到服务器端存储
            $.ajax({
                url:'<?php echo url("tianjia","",false); ?>',  // /admin/role/xiugai
                data:shuju,
                dataType:'json',
                type:'post',
