<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\www\php68\public/../application/home\view\shop\jiesuan.html";i:1534822102;s:49:"F:\www\php68\application\home\view\pub\head2.html";i:1534733892;s:49:"F:\www\php68\application\home\view\pub\foot2.html";i:1534732776;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--主内容-->
<form action="<?php echo url('makeorder'); ?>" method="post">
					...
					<ul class="addr-detail">
						<li class="addr-item">
							...
							<div class="con address">
								<?php echo $v['cgn_address']; ?>
								<span><?php echo $v['cgn_tel']; ?></span>
							</div>
					...
					<ul class="send-detail">
						<li>
							...
							<div class="sendGoods">
								...
								<ul class="yui3-g">
									<li class="yui3-u-1-6">
										<span><img src="<?php echo substr($v['cgoods_logo'],1); ?>"/></span>
									</li>
									...
									<li class="yui3-u-1-12"><div class="exit"><?php echo $v['cgoods_price_sum']; ?></div></li>
								</ul>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
